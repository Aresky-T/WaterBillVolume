...
function VolumeForAdmin({ user, year, month, setUser, setYear, setMonth, setDate, setHourStart, setHourEnd }) {
        ...
        <div className='session volume-admin'>
            <div className="volume_left">
                ...
                {listUsers && [...listUsers].map((item, index) => (
                    <button
                        className={item._id === user._id ? 'active' : ''}
            ...
            {user && <div className="volume-right">
